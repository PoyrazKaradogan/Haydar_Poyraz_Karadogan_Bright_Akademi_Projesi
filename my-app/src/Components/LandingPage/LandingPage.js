...
<button className='btn btn-outline-primary fs-3 d-flex m-2'>Detaylı Bilgi</button>
<button className='btn btn-outline-danger fs-3 d-flex m-2'src="../../Pages/Contact/Contact">İletişim</button>
</div>
